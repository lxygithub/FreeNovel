...
public abstract class PageLoader {
    ...
    // 当前章节列表
    protected List<ChapterBean> mChapterList = new ArrayList<>(1);
    // 书本对象
    ...
    public void saveRecord() {
        ...
        //存储到数据库
        bookRepository.saveBookRecord(mBookRecord);
    }
    ...
    private void drawBackground(Bitmap bitmap, boolean isUpdate) {
        ...
        //底部的字显示的位置Y
        float y = mDisplayHeight - mTipPaint.getFontMetrics().bottom - tipMarginHeight;
        String time = DateUtil.INSTANCE.dateConvert(System.currentTimeMillis(), Constant.FORMAT_TIME);
...
//                }
    ...
    private List<TxtPage> loadPages(ChapterBean chapter, BufferedReader br) {
        ...
        String title = StringUtils.INSTANCE.convertCC(chapter.getName());
        String half;
        try {
    ...
    public interface OnPageChangeListener {
         ...
         */
        void chapterContents(List<ChapterBean> requestChapters);
         ...
         */
        void onChaptersFinished(List<ChapterBean> chapters);
